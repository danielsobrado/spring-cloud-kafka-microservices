...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Review findByProductId(String productId) {
        ...
        return reviewRepository.findByProductId(productId).orElseThrow(() -> new ResourceNotFoundException(TABLE_NAME, "productId", productId));
    }
    ...
    public Review findById(Long id) {
        ...
        return reviewRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException(TABLE_NAME, "id", id));
    }
