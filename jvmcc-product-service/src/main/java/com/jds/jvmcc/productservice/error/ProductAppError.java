 ...
 * @since 2022-08-21
 */
public class ProductAppError {

    private final String apiVersion;
    private final ErrorBlock error;

    public ProductAppError(final String apiVersion, final String code, final String message, final String domain,
                             final String reason, final String errorMessage) {
        this.apiVersion = apiVersion;
        this.error = new ErrorBlock(code, message, domain, reason, errorMessage);
    }

    public static ProductAppError fromDefaultAttributeMap(final String apiVersion,
